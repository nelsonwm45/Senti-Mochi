...
export default function ChatSidebar({
  ...
  return (
    <>
      ...
      <motion.div
        className={cn(
          "fixed lg:static top-0 left-0 z-40 h-full bg-glass-bg border-r border-glass-border flex flex-col backdrop-blur-xl",
          "transition-[transform,width] duration-300 ease-in-out",
          // Mobile: always w-80, slide in/out
          "w-80",
          isOpen ? "translate-x-0" : "-translate-x-full",
          // Desktop: always translated 0, animate width
          "lg:translate-x-0",
          isOpen ? "lg:w-80" : "lg:w-0 lg:border-r-0 lg:overflow-hidden"
        )}
      >
        {/* Inner Content Wrapper - Prevents content squashing when closing */}
